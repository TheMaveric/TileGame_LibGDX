...
public class Terrain implements Runnable{
    public static final int width=Gdx.graphics.getWidth() / Tile.TILEWIDTH,height=Gdx.graphics.getHeight() /(Tile.TILEHEIGHT);
    ...
    public void terrain(String s,Batch batch){
        try {
            ...
            entityList=c.init(width, height, "Tree Noise", 50, 0, 100, 0, x, y,biome,batch,islandArr);
